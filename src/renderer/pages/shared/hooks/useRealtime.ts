...
const REGISTRY: Record<string, ResourceRegistryEntry> = {
  ...
  habits: { storeKey: 'habits', fromApi: habitFromApi, tombstoneResource: 'habits' },
  habit_entries: { storeKey: 'habitEntries', fromApi: habitEntryFromApi, tombstoneResource: 'habit_entries' },
  ...
  crm_contacts: { storeKey: 'crmContacts', fromApi: crmContactFromApi, tombstoneResource: 'crm_contacts' },
  crm_tags: { storeKey: 'crmTags', fromApi: crmTagFromApi, tombstoneResource: 'crm_tags' },
  crm_interactions: { storeKey: 'crmInteractions', fromApi: crmInteractionFromApi, tombstoneResource: 'crm_interactions' },
