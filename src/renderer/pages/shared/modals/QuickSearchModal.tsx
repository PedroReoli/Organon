...
type QuickResult =
  ...
  | { kind: 'git_repo'; id: string; title: string; group: string; path: string }
...
export const QuickSearchModal = ({
  ...
  }, [query, cards, events, shortcuts, notes, noteContentResults])
    ...
    <div className="quick-search-inline">
      <div className="quick-search-input-wrapper">
        ...
        <input
          ...
          placeholder="Buscar cards, eventos, atalhos e notas..."
          value={query}
          ...
          {results.map((r, idx) => (
            ...
            >
              <div className="quick-result-title">
                ...
                {r.kind === 'git_repo' && (
                  <span className="quick-kind" style={{ background: '#3b82f622', color: '#60a5fa' }}>Git Repo</span>
                )}
