...
import { WhisperRecordDialogs } from './WhisperRecordDialogs'
...
export const WhisperSidebar: React.FC<Props> = ({
  ...
  return (
    ...
    >
      ...
      {/* Modais Inline de Renomear e Deletar */}
      <WhisperRecordDialogs
        renamingRecord={renamingRecord}
        onRenamingChange={setRenamingRecord}
        onConfirmRename={handleConfirmRename}
        deletingRecord={deletingRecord}
        onCancelDelete={() => setDeletingRecord(null)}
