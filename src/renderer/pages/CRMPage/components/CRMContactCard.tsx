...
export const CRMContactCard = ({
  ...
  return (
    <div
      ...
      data-debug-name="CRMContactCard"
      data-debug-id={contact.id}
    >
      <div className="crm-card-header">
        <div className="crm-card-name" onClick={onEdit} style={{ cursor: 'pointer', flex: 1, fontWeight: 700 }}>{contact.name}</div>
        <div
        ...
        <div
          {...listeners}
          {...attributes}
          style={{ cursor: 'grab', padding: '2px 6px', opacity: 0.7, fontSize: '14px', userSelect: 'none' }}
          title="Arrastar contato para outra etapa"
        >
          ⋮⋮
        </div>
      </div>
