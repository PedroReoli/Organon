...
const NAV_GROUPS: { label: string; items: { id: string; label: string; electronOnly?: boolean; devOnly?: boolean; icon: React.ReactNode }[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'backup', label: 'Backup & Restaurar', icon: <svg viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5" width="14" height="14"><path d="M13 13.5H3a1 1 0 0 1-1-1v-9a1 1 0 0 1 1-1h7.5l2.5 2.5v7.5a1 1 0 0 1-1 1z" /><path d="M5 2.5v3h5v-3" /><path d="M5.5 9h5" /><path d="M5.5 11h3" /></svg> },
    ],
  },
  {
    label: 'Desenvolvedor',
...
export const SettingsNav = ({ activeSection, setActiveSection }: SettingsNavProps) => (
