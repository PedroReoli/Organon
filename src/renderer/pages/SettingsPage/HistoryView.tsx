...
import type { AppItem, CalendarEvent, Card, Meeting, Note, Project } from '@types'

type HistoryKind = 'card' | 'event' | 'note' | 'app' | 'project' | 'meeting'
...
export const HistoryView = ({
  ...
  }, [apps, cards, events, meetings, notes, projects])
    ...
    <div className="history-layout">
      <header className="history-header">
        ...
        <div className="history-filters">
          ...
          {(['card', 'event', 'note', 'app', 'project', 'meeting'] as HistoryKind[]).map(kind => (
            <button
              key={kind}
