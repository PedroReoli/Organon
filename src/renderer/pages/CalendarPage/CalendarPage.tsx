...
export const CalendarView = ({ cards, events, onAddEvent, onRemoveEvent, reduceModeSignal, focusDateISO, onFocusDateHandled }: CalendarViewProps) => {
  ...
  const [newEventColor, setNewEventColor] = useState('var(--color-primary)')
      ...
      <div className="calendar-layout">
        <header className="calendar-header">
          ...
          <div className="calendar-nav">
            <Button variant="secondary" size="sm" onClick={goToPrevMonth}>&lt;</Button>
        ...
        {selectedDate && (
          <>
            <div className="calendar-side-header">
              ...
              <Button variant="secondary" size="sm" onClick={() => setSelectedDate(null)} title="Fechar">&times;</Button>
            </div>
